...
class FrontendController extends Controller
{
    ...
    /**
     * Legacy ecommerce homepage data kept for the other theme components.
     * The blog-focused homepage no longer executes these queries.
     */
