        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <img id="featured-image-preview" class="admin-img lg" src="{{ $item->photo ? url('storage/images/'.$item->photo) : url('storage/images/placeholder.png') }}" alt="{{ __('Featured Image') }}">
                    </div>
